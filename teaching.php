...
while(false!==($f=readdir($h)))
{
	...
	else$files[]=array('name'=>$f,'size'=>filesize($path.$f),'date'=>filemtime($path.$f),'url'=>trim("teaching/$dir/".rawurlencode($f),'/'));
}
closedir($h);
...
<div class="topnav">
        ...
        <button class="active"><a href="teaching.php" >Courses</a> </button>
