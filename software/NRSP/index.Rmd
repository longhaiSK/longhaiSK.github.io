...
author: "[Longhai Li](https://longhaisk.github.io/), `r format(Sys.Date(),'%B %d, %Y')`"
output: 
  html_document:
    toc: false
...
knitr::opts_chunk$set(klippy = TRUE)
...
<li> 
	Wu, T., <b>Li, L.</b>, Feng, C. (2025). Z-residual diagnostic tool for assessing covariate functional form in shared frailty models. <a href="https://doi.org/10.1080/02664763.2024.2355551">Journal of Applied Statistics 52(1), 28–58.</a> 
...
<li> 
	<b>Li, L.</b>, Wu, T., Feng, C. (2021). Model diagnostics for censored regression via randomized survival probabilities. <a href="https://doi.org/10.1002/sim.8852">Statistics in Medicine 40, 1482–1497</a>.	<a href="/doc/1911.00198v4.pdf">[<b>PDF</b>]</a>;
...
### Generic R Functions for Computing Z-residuals for <code>survreg</code> and <code>coxph</code> Objects
```{r zresid}
