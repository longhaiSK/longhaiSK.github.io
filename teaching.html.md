...
```{=html}
<div id="vvtvtdjera" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#vvtvtdjera table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#vvtvtdjera thead, #vvtvtdjera tbody, #vvtvtdjera tfoot, #vvtvtdjera tr, #vvtvtdjera td, #vvtvtdjera th {
  border-style: none;
}
...
#vvtvtdjera .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#vvtvtdjera .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#vvtvtdjera .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: bold;
...
#vvtvtdjera .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#vvtvtdjera .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#vvtvtdjera .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#vvtvtdjera .gt_spanner_row {
  border-bottom-style: hidden;
}

#vvtvtdjera .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vvtvtdjera .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#vvtvtdjera .gt_from_md > :first-child {
  margin-top: 0;
}

#vvtvtdjera .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#vvtvtdjera .gt_row_group_first td {
  border-top-width: 2px;
}

#vvtvtdjera .gt_row_group_first th {
  border-top-width: 2px;
}

#vvtvtdjera .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#vvtvtdjera .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#vvtvtdjera .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#vvtvtdjera .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vvtvtdjera .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#vvtvtdjera .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vvtvtdjera .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#vvtvtdjera .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#vvtvtdjera .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#vvtvtdjera .gt_font_normal {
  font-weight: normal;
}

#vvtvtdjera .gt_font_bold {
  font-weight: bold;
}

#vvtvtdjera .gt_font_italic {
  font-style: italic;
}
...
#vvtvtdjera .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#vvtvtdjera .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#vvtvtdjera .gt_indent_1 {
  text-indent: 5px;
}

#vvtvtdjera .gt_indent_2 {
  text-indent: 10px;
}

#vvtvtdjera .gt_indent_3 {
  text-indent: 15px;
}

#vvtvtdjera .gt_indent_4 {
  text-indent: 20px;
}

#vvtvtdjera .gt_indent_5 {
  text-indent: 25px;
}

#vvtvtdjera .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#vvtvtdjera div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
