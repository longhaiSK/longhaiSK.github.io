...
final_guide <- data.frame(
  ...
  Skills = c(
    ...
    "Derive MLEs analytically, calculate asymptotic variances using Fisher information, identify the asymptotic distribution of MLE, compute AIC",
