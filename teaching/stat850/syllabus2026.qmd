...
final_guide <- data.frame(
  ...
  Skills = c(
    ...
    "Derive MLEs analytically, calculate asymptotic variances using Fisher information, compute AIC",
    "Construct UMP tests using MLR, and derive Likelihood Ratio tests, Score tests, and Wald tests.",
