...
```{=html}
<div id="yutqjtccpi" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#yutqjtccpi table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#yutqjtccpi thead, #yutqjtccpi tbody, #yutqjtccpi tfoot, #yutqjtccpi tr, #yutqjtccpi td, #yutqjtccpi th {
  border-style: none;
}
...
#yutqjtccpi .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#yutqjtccpi .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#yutqjtccpi .gt_column_spanner_outer {
  color: #333333;
  background-color: #F0F0F0;
  font-size: 100%;
  font-weight: normal;
...
#yutqjtccpi .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#yutqjtccpi .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#yutqjtccpi .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#yutqjtccpi .gt_spanner_row {
  border-bottom-style: hidden;
}

#yutqjtccpi .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yutqjtccpi .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#yutqjtccpi .gt_from_md > :first-child {
  margin-top: 0;
}

#yutqjtccpi .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#yutqjtccpi .gt_row_group_first td {
  border-top-width: 2px;
}

#yutqjtccpi .gt_row_group_first th {
  border-top-width: 2px;
}

#yutqjtccpi .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#yutqjtccpi .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#yutqjtccpi .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#yutqjtccpi .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yutqjtccpi .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#yutqjtccpi .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yutqjtccpi .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yutqjtccpi .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#yutqjtccpi .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#yutqjtccpi .gt_font_normal {
  font-weight: normal;
}

#yutqjtccpi .gt_font_bold {
  font-weight: bold;
}

#yutqjtccpi .gt_font_italic {
  font-style: italic;
}
...
#yutqjtccpi .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#yutqjtccpi .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#yutqjtccpi .gt_indent_1 {
  text-indent: 5px;
}

#yutqjtccpi .gt_indent_2 {
  text-indent: 10px;
}

#yutqjtccpi .gt_indent_3 {
  text-indent: 15px;
}

#yutqjtccpi .gt_indent_4 {
  text-indent: 20px;
}

#yutqjtccpi .gt_indent_5 {
  text-indent: 25px;
}

#yutqjtccpi .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#yutqjtccpi div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<table class="gt_table" style="table-layout:fixed;width:100%;" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
  ...
  <thead>
    <tr class="gt_col_headings">
      ...
      <th class="gt_col_heading gt_columns_bottom_border gt_center" rowspan="1" colspan="1" scope="col" id="Acad_Week"><span data-qmd-base64="KipBY2FkZW1pYyBXZWVrKio="><span class='gt_from_md'><strong>Academic Week</strong></span></span></th>
      ...
      <th class="gt_col_heading gt_columns_bottom_border gt_left" rowspan="1" colspan="1" scope="col" id="Task"><span data-qmd-base64="KipUYXNrKio="><span class='gt_from_md'><strong>Task</strong></span></span></th>
    </tr>
  </thead>
  <tbody class="gt_table_body">
    <tr><td headers="Date" class="gt_row gt_left">Jan 04</td>
...
<td headers="Task" class="gt_row gt_left"><span data-qmd-base64="KipDb3Vyc2UgU3RhcnRzIChKYW4gMDYpKio="><span class='gt_from_md'><strong>Course Starts (Jan 06)</strong></span></span></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Jan 11</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">2</td>
<td headers="Topic" class="gt_row gt_left gt_striped">2. Likelihood Theory: Sufficient Statistic</td>
<td headers="Task" class="gt_row gt_left gt_striped"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left">Jan 18</td>
<td headers="Acad_Week" class="gt_row gt_center">3</td>
<td headers="Topic" class="gt_row gt_left">3. Likelihood Theory: Bartlett's Identities, CR Lower Bound</td>
<td headers="Task" class="gt_row gt_left"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Jan 25</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">4</td>
<td headers="Topic" class="gt_row gt_left gt_striped">3. Likelihood Theory: Exponential Families</td>
<td headers="Task" class="gt_row gt_left gt_striped"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left">Feb 01</td>
<td headers="Acad_Week" class="gt_row gt_center">5</td>
<td headers="Topic" class="gt_row gt_left">4. Maximum Likelihood Estimation: Score, Fisher Information, Newton-Raphson Methods</td>
<td headers="Task" class="gt_row gt_left"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Feb 08</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">6</td>
<td headers="Topic" class="gt_row gt_left gt_striped">4. Maximum Likelihood Estimation: Asymptotics of MLE, AIC, Deep Learning</td>
<td headers="Task" class="gt_row gt_left gt_striped"><span data-qmd-base64="KipBc3NpZ25tZW50IDEgZHVlKio="><span class='gt_from_md'><strong>Assignment 1 due</strong></span></span></td></tr>
    <tr><td headers="Date" class="gt_row gt_left" style="background-color: #D1E7DD; font-style: italic; font-weight: bold;">Feb 15</td>
...
<td headers="Task" class="gt_row gt_left" style="background-color: #D1E7DD; font-style: italic; font-weight: bold;"><span data-qmd-base64="KipSZWFkaW5nIFdlZWsg4oCTIE5vIGNsYXNzZXMqKg=="><span class='gt_from_md'><strong>Reading Week – No classes</strong></span></span></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Feb 22</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">7</td>
<td headers="Topic" class="gt_row gt_left gt_striped">5. Hypothesis Testing: NP Lemma, Monotone Likelihood Test, Likelihood-based Tests</td>
<td headers="Task" class="gt_row gt_left gt_striped"><span data-qmd-base64="KipNaWR0ZXJtIChkdXJpbmcgY2xhc3MpKio="><span class='gt_from_md'><strong>Midterm (during class)</strong></span></span></td></tr>
    <tr><td headers="Date" class="gt_row gt_left">Mar 01</td>
<td headers="Acad_Week" class="gt_row gt_center">8</td>
<td headers="Topic" class="gt_row gt_left">6. Uniformly Minimum Variance Unbiased Tests: Complete Statistic, UMVUE</td>
<td headers="Task" class="gt_row gt_left"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Mar 08</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">9</td>
<td headers="Topic" class="gt_row gt_left gt_striped">7. Decision Theory: Risk, Minimaxity Theorem</td>
<td headers="Task" class="gt_row gt_left gt_striped"><span data-qmd-base64="KipBc3NpZ25tZW50IDIgZHVlKio="><span class='gt_from_md'><strong>Assignment 2 due</strong></span></span></td></tr>
    <tr><td headers="Date" class="gt_row gt_left">Mar 15</td>
<td headers="Acad_Week" class="gt_row gt_center">10</td>
<td headers="Topic" class="gt_row gt_left">7. Bayesian Inference: Posterior, Bayes Rules, Bayes Risk</td>
<td headers="Task" class="gt_row gt_left"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Mar 22</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">11</td>
<td headers="Topic" class="gt_row gt_left gt_striped">7. Bayesian Inference: Minimax Rules, James-Stein Estimator</td>
<td headers="Task" class="gt_row gt_left gt_striped"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left">Mar 29</td>
<td headers="Acad_Week" class="gt_row gt_center">12</td>
<td headers="Topic" class="gt_row gt_left">7. Bayesian Inference: Empirical Bayes, Hierarchical Bayesian, MCMC, Case Study</td>
<td headers="Task" class="gt_row gt_left"></td></tr>
    <tr><td headers="Date" class="gt_row gt_left gt_striped">Apr 05</td>
<td headers="Acad_Week" class="gt_row gt_center gt_striped">13</td>
<td headers="Topic" class="gt_row gt_left gt_striped">Review</td>
<td headers="Task" class="gt_row gt_left gt_striped"><span data-qmd-base64="KipBc3NpZ25tZW50IDMgZHVlKio8YnI+KipDb3Vyc2UgRW5kcyAoQXByIDA4KSoq"><span class='gt_from_md'><strong>Assignment 3 due</strong><br><strong>Course Ends (Apr 08)</strong></span></span></td></tr>
  </tbody>
...
```{=html}
<div id="rubomctuwx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#rubomctuwx table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#rubomctuwx thead, #rubomctuwx tbody, #rubomctuwx tfoot, #rubomctuwx tr, #rubomctuwx td, #rubomctuwx th {
  border-style: none;
}
...
#rubomctuwx .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#rubomctuwx .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#rubomctuwx .gt_column_spanner_outer {
  color: #333333;
  background-color: #E0E0E0;
  font-size: 100%;
  font-weight: bold;
...
#rubomctuwx .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#rubomctuwx .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#rubomctuwx .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#rubomctuwx .gt_spanner_row {
  border-bottom-style: hidden;
}

#rubomctuwx .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rubomctuwx .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#rubomctuwx .gt_from_md > :first-child {
  margin-top: 0;
}

#rubomctuwx .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#rubomctuwx .gt_row_group_first td {
  border-top-width: 2px;
}

#rubomctuwx .gt_row_group_first th {
  border-top-width: 2px;
}

#rubomctuwx .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#rubomctuwx .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#rubomctuwx .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#rubomctuwx .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rubomctuwx .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#rubomctuwx .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rubomctuwx .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rubomctuwx .gt_striped {
  background-color: #F5F5F5;
}

#rubomctuwx .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#rubomctuwx .gt_font_normal {
  font-weight: normal;
}

#rubomctuwx .gt_font_bold {
  font-weight: bold;
}

#rubomctuwx .gt_font_italic {
  font-style: italic;
}
...
#rubomctuwx .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#rubomctuwx .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#rubomctuwx .gt_indent_1 {
  text-indent: 5px;
}

#rubomctuwx .gt_indent_2 {
  text-indent: 10px;
}

#rubomctuwx .gt_indent_3 {
  text-indent: 15px;
}

#rubomctuwx .gt_indent_4 {
  text-indent: 20px;
}

#rubomctuwx .gt_indent_5 {
  text-indent: 25px;
}

#rubomctuwx .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#rubomctuwx div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" style="table-layout:fixed;width:100%;" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
