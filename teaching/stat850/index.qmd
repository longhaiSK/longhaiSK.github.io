...
This course presents a rigorous theoretical treatment of statistical inference, offering a comparative analysis of Bayesian, Likelihood, and Frequentist paradigms grounded in Decision Theory. Core topics include the geometry of Exponential Families and the principles of Data Reduction, utilizing Sufficiency and Completeness to derive Uniformly Minimum Variance Unbiased Estimators (UMVUE). The course further examines hypothesis testing through the Neyman-Pearson framework to construct Uniformly Most Powerful (UMP) tests, and concludes with the asymptotic theory of Maximum Likelihood, culminating in the derivation of Wilks’ Theorem and the geometry of likelihood-based inference.

**Prerequisite(s):** STAT 342. This course requires a strong command of multivariate calculus, alongside a rigorous foundation in intermediate probability theory. Students should also possess prior exposure to applied statistical methods, particularly regression analysis.
...
* My Lecture Notes
  [HTML](mathstat/index.html){.btn .btn-primary .btn-sm}
  [Hand-written](mathstat/stat850_lec.pdf){.btn .btn-primary .btn-sm}
...
* **Recommended Text:** Young G. A. & R. L. Smith, *Essentials of Statistical Inference*, Cambridge University Press, 2005. *My lecture notes largely follow this textbook.*
...
topics_list <- c(
  ...
  "Jan 12" = "1. Decision Theory ",
  "Jan 19" = "2. Bayesian Inference  ",
  "Jan 26" = "2. Bayesian Inference  ",
  "Feb 02" = "2. Bayesian Inference  ",
  "Feb 09" = "3. Hypothesis Testing ",
  "Feb 16" = "—", 
  "Feb 23" = "3. Hypothesis Testing ",
  "Mar 02" = "4. Likelihood Ratio Test and Information Criteria",
  "Mar 09" = "5. Sufficient and Complete Statistics",
  "Mar 16" = "5. Sufficient and Complete Statistics",
  "Mar 23" = "6. Likelihood Theory",
  "Mar 30" = "6. Likelihood Theory",
  "Apr 06" = "Review"
)
