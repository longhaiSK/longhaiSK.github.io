...
::: {#exm-stein-polynomial}
### Another Example Verifying Stein's Lemma
...
**Step 2: Expectation with respect to Marginal $X$** We now take the expectation $E_m[\cdot]$ of the posterior loss. Recall $X \sim N(0, (1+\sigma^2)I)$, so $E[||X||^2] = p(1+\sigma^2)$ and $E[1/||X||^2] = \frac{1}{(p-2)(1+\sigma^2)}$.
