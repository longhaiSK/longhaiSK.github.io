...
mse_table <- data.frame(
  Method = c("Simple (MLE)", "James-Stein", "Fully Bayesian (brms)"),
  MSE = round(c(mse_mle, mse_js, mse_brms), 3)
)

knitr::kable(mse_table, caption = "Comparison of Estimation Error (Sum of Squared Differences)")
```
...
```{r}
#| label: fig-shrinkage
#| fig-cap: "Shrinkage Effect: Estimated vs True Strike Rate"
#| echo: true
#| fig-height: 5
...
```{r}
#| label: fig-density-rb
#| fig-cap: "Posterior Density for Player 1 (McGwire)"
#| echo: true
