...
## Score Vector and Fisher Information of Regular Families
...
3.  **Fisher Information Matrix ($I$):** The covariance matrix of the score vector. It is a deterministic $p \times p$ matrix (for a fixed $\theta$).
    $$
...
3.  **Higher-Order Moments:**
    In general, the $k$-th partial derivative of $A(\eta)$ with respect to components of $\eta$ corresponds to the $k$-th **cumulant** of the sufficient statistics.
:::
