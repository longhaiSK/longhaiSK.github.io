...
2. Fisher Information ($\mathcal{I}(\theta)$) We calculate the information using two different definitions to verify Bartlett's identity.
   ...
   **Result:** $\text{Var}(U) = -E[U'] = \mathcal{I}(\theta)$. (Identity Verified)
