...
### Asympotic Distribution of Normal Sample
...
We now demonstrate that $\mathbf{U}(\boldsymbol{\theta})$ follows a Normal distribution $N(\mathbf{0}, \mathcal{I}(\boldsymbol{\theta}))$.
...
## Poisson Regression (Asymptotic Theory)
...
### Asympotic Distributions of Poisson Regression
