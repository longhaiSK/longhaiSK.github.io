...
#| fig-cap: "Expected Log-Likelihood $\\ell^*(\\theta)$ and 10 realized $\\ell(\\theta)$ curves. The largest sample is highlighted in blue, showing the 1/2 Deviance gap. The MLEs are marked on the Score = 0 line."
#| fig-pos: "H"
...
legend("topleft", 
       legend = c("Expected $\\ell^*(\\theta)$", "Realized $\\ell(\\theta)$", "True Null $\\theta_0$", "Score Function $U_n(\\theta)$"),
