...
$$
D(\hat{\theta}; Y_{\mathrm{train}}) \approx D(\theta_0; Y_{\mathrm{train}}) - W
$$
...
$$\mathbb{E}_{Y_{\mathrm{test}}}[D(\hat{\theta}; Y_{\mathrm{test}}) \mid \hat{\theta}] \approx \mathbb{E}_{Y_{\mathrm{test}}}[D(\theta_0; Y_{\mathrm{test}})] + W$$.
