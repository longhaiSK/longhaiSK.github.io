...
#| fig-cap: "Comparison of the Exact, Asymptotic Normal, and Log-Normal Approximated CDFs of the sample variance."
#| echo: true
#| fig-align: "center"
...
plot(x, cdf_exact, type = "l", col = "black", lwd = 2,
     ...
     main = expression(paste("CDFs of ", hat(sigma)^2, " (n = 10, ", sigma^2, " = 1)")),
     ylim = c(0, 1))
