...
1. **Set Up the Variance Expression** Let $u_{ij}(\boldsymbol{\beta})$ denote the gradient contribution of the $i$-th observation with respect to the parameter $\beta_j$:
   $$
