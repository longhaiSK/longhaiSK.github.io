...
```{=html}
<div id="ldlzgljndk" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#ldlzgljndk table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#ldlzgljndk thead, #ldlzgljndk tbody, #ldlzgljndk tfoot, #ldlzgljndk tr, #ldlzgljndk td, #ldlzgljndk th {
  border-style: none;
}
...
#ldlzgljndk .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#ldlzgljndk .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#ldlzgljndk .gt_column_spanner_outer {
  color: #333333;
  background-color: #F0F0F0;
  font-size: 100%;
  font-weight: normal;
...
#ldlzgljndk .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#ldlzgljndk .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#ldlzgljndk .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#ldlzgljndk .gt_spanner_row {
  border-bottom-style: hidden;
}

#ldlzgljndk .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ldlzgljndk .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#ldlzgljndk .gt_from_md > :first-child {
  margin-top: 0;
}

#ldlzgljndk .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#ldlzgljndk .gt_row_group_first td {
  border-top-width: 2px;
}

#ldlzgljndk .gt_row_group_first th {
  border-top-width: 2px;
}

#ldlzgljndk .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#ldlzgljndk .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#ldlzgljndk .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#ldlzgljndk .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ldlzgljndk .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#ldlzgljndk .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ldlzgljndk .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#ldlzgljndk .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#ldlzgljndk .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#ldlzgljndk .gt_font_normal {
  font-weight: normal;
}

#ldlzgljndk .gt_font_bold {
  font-weight: bold;
}

#ldlzgljndk .gt_font_italic {
  font-style: italic;
}
...
#ldlzgljndk .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#ldlzgljndk .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#ldlzgljndk .gt_indent_1 {
  text-indent: 5px;
}

#ldlzgljndk .gt_indent_2 {
  text-indent: 10px;
}

#ldlzgljndk .gt_indent_3 {
  text-indent: 15px;
}

#ldlzgljndk .gt_indent_4 {
  text-indent: 20px;
}

#ldlzgljndk .gt_indent_5 {
  text-indent: 25px;
}

#ldlzgljndk .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#ldlzgljndk div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
```{=html}
<div id="qvqkdvxrig" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#qvqkdvxrig table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#qvqkdvxrig thead, #qvqkdvxrig tbody, #qvqkdvxrig tfoot, #qvqkdvxrig tr, #qvqkdvxrig td, #qvqkdvxrig th {
  border-style: none;
}
...
#qvqkdvxrig .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#qvqkdvxrig .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#qvqkdvxrig .gt_column_spanner_outer {
  color: #333333;
  background-color: #E0E0E0;
  font-size: 100%;
  font-weight: bold;
...
#qvqkdvxrig .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#qvqkdvxrig .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#qvqkdvxrig .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#qvqkdvxrig .gt_spanner_row {
  border-bottom-style: hidden;
}

#qvqkdvxrig .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvqkdvxrig .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#qvqkdvxrig .gt_from_md > :first-child {
  margin-top: 0;
}

#qvqkdvxrig .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#qvqkdvxrig .gt_row_group_first td {
  border-top-width: 2px;
}

#qvqkdvxrig .gt_row_group_first th {
  border-top-width: 2px;
}

#qvqkdvxrig .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#qvqkdvxrig .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#qvqkdvxrig .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#qvqkdvxrig .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvqkdvxrig .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#qvqkdvxrig .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvqkdvxrig .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvqkdvxrig .gt_striped {
  background-color: #F5F5F5;
}

#qvqkdvxrig .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#qvqkdvxrig .gt_font_normal {
  font-weight: normal;
}

#qvqkdvxrig .gt_font_bold {
  font-weight: bold;
}

#qvqkdvxrig .gt_font_italic {
  font-style: italic;
}
...
#qvqkdvxrig .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#qvqkdvxrig .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#qvqkdvxrig .gt_indent_1 {
  text-indent: 5px;
}

#qvqkdvxrig .gt_indent_2 {
  text-indent: 10px;
}

#qvqkdvxrig .gt_indent_3 {
  text-indent: 15px;
}

#qvqkdvxrig .gt_indent_4 {
  text-indent: 20px;
}

#qvqkdvxrig .gt_indent_5 {
  text-indent: 25px;
}

#qvqkdvxrig .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#qvqkdvxrig div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
  height: 0px !important;
}
</style>
<table class="gt_table" style="table-layout:fixed;width:100%;" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
