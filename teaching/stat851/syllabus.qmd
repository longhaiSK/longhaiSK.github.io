...
schedule_data %>%
  ...
  # --- STYLING OPTIONS ---
  tab_options(
    # 1. Full Grid Lines (Body)
    table_body.hlines.style = "solid",
    table_body.vlines.style = "solid",
    
    # 2. Header Grid Lines (Extend vlines to header)
    column_labels.vlines.style = "solid",       # Vertical lines between headers
    column_labels.border.bottom.style = "solid", # Line between header and body
    column_labels.border.top.style = "solid",    # Line above header
