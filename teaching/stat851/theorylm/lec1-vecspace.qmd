...
#| label: extract-p23
#| include: false
extract_page_image(23, "page23_span.png", "1200x600+0+500", force = FALSE)
```
...
### Projection Matrix via Orthonomal Basis
...
### Projection Matrix via $X$ (Least Square Projection Matrix)
