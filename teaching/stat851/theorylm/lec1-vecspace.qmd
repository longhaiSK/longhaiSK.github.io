...
This matrix projects $y$ onto the null space of $X^\top$ (i.e., $\text{Col}(X)^\perp$).
:::
...
1.  $\hat{y}_0 \in C(X_0)$: The fit of the reduced model.
2.  $(\hat{y}_1 - \hat{y}_0) \in C(X_0)^\perp \cap C(X_1)$: The additional fit provided by $M_1$ over $M_0$.
3.  $(y - \hat{y}_1) \in C(X_1)^\perp$: The projection of $y$ onto the **orthogonal complement** of $C(X_1)$.
