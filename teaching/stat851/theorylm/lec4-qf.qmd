...
**Note:** Some definitions of non-central $\chi^2$ use $\lambda = \frac{1}{2}\mu'\mu$. In this course, we use $\lambda = \mu'\mu$. With this convention, the Poisson-mixture representation below uses Poisson($\lambda/2$) weights.
...
$$
z' P_V z = \frac{y' P_V y}{\sigma^2} \sim \chi^2\left(r, \left|\left| P_V \frac{\mu}{\sigma} \right|\right|^2\right)
$$
which simplifies to:
$$
