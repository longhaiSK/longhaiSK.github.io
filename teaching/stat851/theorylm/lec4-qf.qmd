...
::: {#def-f-t-beta name="F, t, and Beta Distributions"}
...
3. **Beta-Distribution:** If $U_1 \sim \chi^2(n_1, \lambda)$ and $U_2 \sim \chi^2(n_2)$ are independent, then $B = \frac{U_1}{U_1 + U_2}$ follows a non-central Beta distribution with parameters $n_1/2, n_2/2$ and non-centrality $\lambda$.
:::
