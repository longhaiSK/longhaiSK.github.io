...
if (knitr::is_latex_output()) {
  gtsave(gt_tbl, "schedule_snapshot_stat851.png", vwidth = 1200) # Uncomment to save locally

  knitr::include_graphics("schedule_snapshot_stat851.png")
  file.remove("schedule_snapshot_stat851.png")
} else{
  gt_tbl
}
```
