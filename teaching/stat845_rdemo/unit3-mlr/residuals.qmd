...
### Extenally Studentized Residuals with Full Data Models ⚙️
...
display_names <- c(
  ...
  # Studentized LOOCV (conceptual)
  "Studentized LOOCV $\\left( \\frac{e_{i,-i}}{\\hat{\\sigma}_{-i}/\\sqrt{1-h_{ii}}} \\right)$",
  # Studentized Full / rstudent (shortcut)
  "Studentized Full (\\texttt{rstudent}) $\\left( \\frac{e_i}{\\hat{\\sigma}_{-i}\\sqrt{1-h_{ii}}} \\right)$"
)
