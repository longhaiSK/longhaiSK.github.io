...
full_data  <- data.frame(x = x, replicate(4, rnorm (n)), y = y)

plot(y~x, data=full_data, pch= flag.outlier, col=flag.outlier)
abline(lm(y~., data=full_data))
...
## Key Identities for Efficient Calculation of LOOCV Residuals and Noice Variance 
