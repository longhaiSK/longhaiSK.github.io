...
# Visual Overview and Key Formulas
...
* $\hat\beta_1$ estimates how much $Y$ changes per one-unit increase in $X$.
...
| :------ | :------------------------------ | :------------------------------------------- |
| **SST** | Total Sum of Squares            | $\displaystyle \sum_i (y_i - \bar y)^2$      |
| **SSR** | Regression Sum of Squares       | $\displaystyle \sum_i (\hat y_i - \bar y)^2$ |
| **SSE** | Error (Residual) Sum of Squares | $\displaystyle \sum_i (y_i - \hat y_i)^2$    |
