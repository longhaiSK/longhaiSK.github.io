...
\pandocbounded{\includegraphics[keepaspectratio]{unit1-introR/introR_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit1-introR/introR_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit1-introR/introR_files/figure-pdf/unnamed-chunk-3-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/unnamed-chunk-10-1.pdf}}
...
\includegraphics[width=5.33in,height=\textheight,keepaspectratio]{unit2-slr/figs/sim_h0.png}
...
\includegraphics[width=5.33in,height=\textheight,keepaspectratio]{unit2-slr/figs/sim_HA.png}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/plot-fit-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/plot-bands-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/residual-analysis-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit2-slr/slr_files/figure-pdf/correlation-data-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-4-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
{\centering \includegraphics[width=8in,height=\textheight,keepaspectratio]{unit3-mlr/figs/rss-h0.png}
...
{\centering \includegraphics[width=8in,height=\textheight,keepaspectratio]{unit3-mlr/figs/rss-h1.png}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-18-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-20-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-20-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-20-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-22-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-25-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-27-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-29-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-31-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/residuals_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/residuals_files/figure-pdf/plot-five-residuals-new-names-1.pdf}}
...
\ControlFlowTok{if}\NormalTok{ (knitr}\SpecialCharTok{::}\FunctionTok{is\_html\_output}\NormalTok{()) \{}
  \DocumentationTok{\#\# HTML → Quarto prints \textasciigrave{}df\textasciigrave{} as a paged table and uses tbl{-}cap}
  \FunctionTok{library}\NormalTok{(DT)}
\NormalTok{  DT}\SpecialCharTok{::}\FunctionTok{datatable}\NormalTok{(}
\NormalTok{    df,}
    \AttributeTok{rownames =} \ConstantTok{FALSE}\NormalTok{,}
    \AttributeTok{options =} \FunctionTok{list}\NormalTok{(}\AttributeTok{pageLength =} \DecValTok{10}\NormalTok{, }\AttributeTok{scrollX =} \ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{caption =}\NormalTok{ htmltools}\SpecialCharTok{::}\NormalTok{tags}\SpecialCharTok{$}\FunctionTok{caption}\NormalTok{(}
      \AttributeTok{style =} \StringTok{\textquotesingle{}caption{-}side: top; text{-}align: left;\textquotesingle{}}\NormalTok{,}
\NormalTok{      htmltools}\SpecialCharTok{::}\FunctionTok{HTML}\NormalTok{(}\StringTok{"Exact 95\% Cook\&\#39;s D critical value (average leverage $h\_\{ii\}=p/n }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{Rightarrow c\_i=1$) vs heuristic $4/n$."}\NormalTok{)}
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
  \DocumentationTok{\#\# Non{-}HTML (PDF, DOCX) → fall back to kable}

\NormalTok{  knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}
\NormalTok{    df,}
    \AttributeTok{align =} \StringTok{"r"}\NormalTok{,}
    \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{,}
    \AttributeTok{caption =} \StringTok{"Exact 95\% Cook\textquotesingle{}s D critical value (average leverage $h\_\{ii\}=p/n }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{Rightarrow c\_i=1$) vs heuristic $4/n$."}
\NormalTok{  ) }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/residuals_files/figure-pdf/cooksD-compute-and-plot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/plot-odds-colored-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/chd-univariate-2x2-jitter-fixedlogit-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/chd-univariate-2x2-jitter-fixedlogit-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/chd-univariate-2x2-jitter-fixedlogit-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/chd-univariate-2x2-jitter-fixedlogit-4.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/plot-sorted-probabilities-sim-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/pr-curve-rocr-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/plot-sorted-probabilities-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/unnamed-chunk-9-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit4-lr/logistic_files/figure-pdf/pr-curve-rocr-chd-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/index-plot-rate-power-segments-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Number of replicates}
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{5} 
\DocumentationTok{\#\# Extract sqrt(MSE) and error df}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/qq-plot-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/residuals-vs-order-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/residuals-vs-fitted-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/plot-interaction-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/plot-diagnostics-rcbd-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/plot-diagnostics-rcbd-2.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/plot-diagnostics-rcbd-3.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{unit5-factor/crbd_files/figure-pdf/plot-diagnostics-rcbd-4.pdf}}
