...
\pandocbounded{\includegraphics[keepaspectratio]{unit3-mlr/mlr_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\CommentTok{\# Conditional check for output format}
\ControlFlowTok{if}\NormalTok{ (knitr}\SpecialCharTok{::}\FunctionTok{is\_html\_output}\NormalTok{()) \{}
  \CommentTok{\# {-}{-}{-} Code for HTML Output (using kableExtra) {-}{-}{-}}
...
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
  \CommentTok{\# {-}{-}{-} Code for PDF/Other Output (using kableExtra) {-}{-}{-}}
\NormalTok{  knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}
\NormalTok{    residuals\_df,}
    \AttributeTok{caption =} \StringTok{"Residual variants."}\NormalTok{,}
    \AttributeTok{col.names =}\NormalTok{ display\_names,}
...
\ControlFlowTok{if}\NormalTok{ (knitr}\SpecialCharTok{::}\FunctionTok{is\_html\_output}\NormalTok{()) \{}
  \CommentTok{\# HTML → Quarto prints \textasciigrave{}df\textasciigrave{} as a paged table and uses tbl{-}cap}
...
\NormalTok{  )}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
  \CommentTok{\# Non{-}HTML (PDF, DOCX) → fall back to kable}
