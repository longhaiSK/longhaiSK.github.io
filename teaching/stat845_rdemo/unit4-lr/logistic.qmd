...
Thus, when interactions are present, the OR varies with the interacting variable(s), and interpretation must be **conditional** （plugged in with) on their specified values.
