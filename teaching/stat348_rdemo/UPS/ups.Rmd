...
est_srs300 <- est_ups15_acres87 <- rep (0, 2000)
for (i in 1:2000)
{
  ## srs sample
  ...
  est_ups15_acres87 [i] <-  upswr_total_est (acres92_ups15, psi) [1] 

}

boxplot (data.frame(est_srs300, est_ups15_acres87))
abline(h=totcares92, col="red")
```
...
boxplot (data.frame(est_srs300, est_ups15_acres87, est_ups300_largef87))
abline(h=totcares92, col="red")

```

# An Example of UPS without replacement
