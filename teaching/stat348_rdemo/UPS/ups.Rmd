...
est_srs300 <- est_ups300_acres87 <- rep (0, 2000)
for (i in 1:2000)
{
  ## srs sample
...
boxplot (data.frame(est_srs300, est_ups300_acres87))
...
boxplot (data.frame(est_srs300, est_ups300_acres87, est_ups300_largef87))
abline(h=totcares92, col="red")
