...
# Include Images Saved in External File
...
If you do not produce PDF directly, you should not include your images as PDF format. Instead, use jpg or png format. You can hide the above R code by setting "echo=FALSE" for the r chunk. For example, I will include the image once again as follows:
