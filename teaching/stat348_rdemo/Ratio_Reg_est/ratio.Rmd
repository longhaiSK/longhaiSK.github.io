...
data.frame(ybarh, sh, nh, prop_h_obs)
```
...
knitr::kable(data.frame ("$x_i$"=cherry$diameter, "$y_i$"=cherry$volume,"$\\hat y_i$"=yhat,
                         "$e_i$"=residuals,check.names=FALSE)) ## for visualization
