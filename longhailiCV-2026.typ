...
4. STAT 442/850: a textbook entitled "#link("teaching/stat850/mathstat/index.html")[Theory of Statistical Inference]" in PDF ($gt.eq$ 200 pages) and HTML.

3. STAT 845: a textbook entitled "#link("teaching/stat845_rdemo/book/index.html")[Statistical Inference and Learning Methods for Research]" in PDF ($gt.eq$ 200 pages) and HTML

2. STAT 443/851: a textbook entitled "#link("teaching/stat851/theorylm/index.html")[Theory of Linear Model]" in PDF ($approx$ 200 pages) and HTML.
